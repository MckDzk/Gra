...
def sklep(kasa, stary_kilof, stalowy_kilof, hartowany_zelazny_kilof, tytanowe_wiertlo):
	while True:
		print("cennik:")
		print("Stalowy Kilof (Zwieksza szczescie wydobycia mineralow i zmniejsza pech) - 2000$, klinkij S by kupic")
		print("Hartowany Zelazny Kilof (Zwieksza ilosc losowego wydarzenia o 2) - 3000$, klinkij H by kupic")
		print("Tytanowe Wiertlo (Zwieksza ilosc losowego wydarzenia o 3 i szczescie wydobycia mineralow - 6000$, klinkij T by kupic")
